...
interstaller = media.Movie("Interstaller",
                            "Man search for a new planet",
                            "poster_image/interstaller.jpg",
                            "https://www.youtube.com/watch?v=0vxOhd4qlnA")

shawshank_redemption = media.Movie("Shawshank Redemption",
                                    "About an honst man that sent to Shawshank Prison, then he could escaped from it",
...
movies = [interstaller, shawshank_redemption, avatar, theory_of_everything, beautiful_mind, school_of_rock]
